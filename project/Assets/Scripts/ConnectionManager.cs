...
public class ConnectionManager : MonoBehaviourPunCallbacks
{
    ...
    void Awake()
    {
        ...
        punWrapper.AutomaticallySyncScene = true;
    }
    ...
    {
        uiManagerWrapper.GetComponent<UIManager>().ToggleMainMenuMultiplayerProgressUI();
    ...
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        ...
        punWrapper.CreateRoom(null, new RoomOptions { MaxPlayers = maxPlayersPerRoom });
    }
    ...
    public void Connect()
    {
        ...
        else
        {
            ...
            isConnecting = punWrapper.ConnectUsingSettings();
            punWrapper.GameVersion = gameVersion;
        }
    }
}